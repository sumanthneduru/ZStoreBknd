...
@RestController
@CrossOrigin(origins = "http://localhost:5173", allowCredentials = "true") // allowCredentials will accept cookies
...
public class ProductController {
	...
	public ResponseEntity<Map<String, Object>> getProducts(@RequestParam(required = false) String category,
		...
		try {
			// Retrieve authenticated user from request (set by filter)
